...
public class GUI {
    ...
    public void run() {
        ...
        // ownerName.setFont(new Font("華康中特圓體(P)", Font.PLAIN, 30));
        ...
        // ownerID.setFont(new Font("華康中特圓體(P)", Font.PLAIN, 30));
        ...
        // Issuer.setFont(new Font("華康中特圓體(P)", Font.PLAIN, 30));
        ...
        // vaild_period.setFont(new Font("華康中特圓體(P)", Font.PLAIN, 30));
